...
#python3 -W ignore run.py --models mistralai/Mixtral-8x7B-Instruct-v0.1 google/flan-t5-xxl google/flan-ul2 lmsys/vicuna-13b-v1.5 Mistral-7B-Instruct-v0.3 --output-dir results
python3 -W ignore run.py --models google/flan-t5-xl google/flan-t5-xxl meta-llama/Meta-Llama-3-8B-Instruct mistralai/Mistral-7B-Instruct-v0.3 --output-dir results
